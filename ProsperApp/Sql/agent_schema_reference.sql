...
-- store_checkouts: one checkout per slip. Split payments are not modeled yet.
...
--     returns cast_id, cast_code, display_name
--   get_business_day_slips(p_department_id bigint, p_business_day_id bigint)
--     returns slip_id, slip_no, table_id, table_code, table_name, opened_at, status, customer_count, memo
--   create_store_slip(
