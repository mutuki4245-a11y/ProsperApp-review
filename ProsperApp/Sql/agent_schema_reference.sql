...
--     Rejects non-standard system items; karaoke is saved via store.save_karaoke_lines and nomination_fee is generated by nomination RPCs.
...
--     updates active standard order quantities on an open slip.
--     p_order_lines uses { order_line_id, quantity }; quantity 0 marks the order line and related backs voided.
