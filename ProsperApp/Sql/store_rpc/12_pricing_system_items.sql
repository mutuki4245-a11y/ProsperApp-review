...
begin
    ...
    values
        (v_company_id, p_department_id, '__system_set_fee__', 'set_fee', 0, false, 0, 0, 0, 'other', -1000, true),
        (v_company_id, p_department_id, '__system_extension_fee__', 'extension_fee', 0, false, 0, 0, 0, 'other', -999, true)
