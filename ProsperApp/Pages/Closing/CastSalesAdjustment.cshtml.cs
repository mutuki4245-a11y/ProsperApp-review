...
public class ClosingCastSalesAdjustmentModel(
    ...
    ILocalSettingsProvider localSettingsProvider) : PageModel
{
    ...
    private async Task LoadAsync(CancellationToken cancellationToken)
    {
        ...
        CastSalesAdjustmentStatus = await _castSalesAdjustmentRepository.GetStatusAsync(
            CurrentBusinessDay.BusinessDayId,
            cancellationToken);
        CastSalesAdjustmentSlips = await _castSalesAdjustmentRepository.GetSlipsAsync(
            CurrentBusinessDay.BusinessDayId,
            cancellationToken);
