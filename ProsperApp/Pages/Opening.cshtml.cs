...
public class OpeningModel(IFeatureGate featureGate, IBusinessDayRepository businessDayRepository) : PageModel
{
    ...
    public async Task<IActionResult> OnPostAsync(CancellationToken cancellationToken)
    {
        ...
        SuccessMessage = $"営業日 {CurrentBusinessDay?.BusinessDate:yyyy-MM-dd} を開始しました。";
        return Page();
    }
}
